...
export const title = [
  'E-Banking, or electronic banking, refers to the use of electronic channels such as the internet, mobile devices, and ATMs to perform banking transactions',
  'Online Banking is a type of electronic banking that allows customers to access and manage their bank accounts through the internet',
  'Mobile Banking is a type of electronic banking that allows customers to access and manage their bank accounts through a mobile device such as a smartphone or tablet',
];
